...
public class Dispense_MedicinesActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
        ...
        switch (checkedId){
            case R.id.dm_tm:
                if(tmf == null){
                    ...
                    list = takeMedicinePresenter.initTakeMedicineForm();
            ...
            case R.id.dm_if:
                if (tf == null){
                    ...
                    list = transfusionPresenter.initTransfusion();
